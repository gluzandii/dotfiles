$env.PATH = ($env.PATH | split row (char esep) | where { $in != "/Users/sushi/Library/Application Support/carapace/bin" } | prepend "/Users/sushi/Library/Application Support/carapace/bin")
